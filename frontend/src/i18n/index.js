...
const i18n = createI18n({
  ...
  messages: {
    en: {
      ...
      noStoriesSorry:
        "You don't have any stories yet. :-( Read stories by other players and join the fun!",
      stats: "Stats",
      profile: "Profile",
      ...
      personalMessagesCount:
        "Overall number of messages written to all the stories from all the characters",
      ...
      leaveFeedback:
        "Leave some feedback on a post you like, and it will appear here!",
      ...
      gloryDescription:
        "A platform created by the TRPG author for other TRPG authors. This is not a forum: you don't need to nor are you able to socialize here. What you can do is write and co-write stories to your heart's content. :-)",
      quickStart: "QUICK START",
      quickStartDetails:
        "Register to get full access to the platform, it's fast and easy. No moderation, no need to write a character info or negotiate with moderators: you can just start playing. Registering to read is also fine.",
      navigation: "INTUITIVE NAVIGATION",
      navigationDetails:
        "Stories are grouped by characters, collections and players. You get a timeline within a collection automatically. Super easy to find and re-read something you know and love.",
      selfGovernance: "SELF-GOVERNANCE",
      selfGovernanceDetails:
        "Create, edit and complete your stories yourselves. Provide background info for your characters or don't. Write at a comfortable pace. Publish stories solo, or play with co-authors. Or you can just read, no one will say a word.",
    ...
    ru: {
      ...
      personalMessagesCount:
        "Постов на сайте за всех персонажей в сумме выложено",
